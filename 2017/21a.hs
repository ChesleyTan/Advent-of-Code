...
instance Eq Three where
    Three [a, b, c] [d, e, f] [g, h, i] == q =
        ...
        in any (\(Three [a', b', c'] [d', e', f'] [g', h', i']) ->
            a' == a && b' == b && c' == c && d' == d && e' == e && f' == f && g' == g && h' == h && i' == i) equiv
...
parseMapping2 ([[a, b], [c, d]], [[a', b', c'], [d', e', f'], [g', h', i']]) = Just (Two [a, b] [c, d], Three [a', b', c'] [d', e', f'] [g', h', i'])
parseMapping2 _ = Nothing

parseMapping3 :: ([String], [String]) -> Maybe (Three, Four)
parseMapping3 ([[a, b, c], [d, e, f], [g, h, i]], [a', b', c', d']) = Just (Three [a, b, c] [d, e, f] [g, h, i], Four a' b' c' d')
...
main = do
    ...
    print $ iterateN 5 0 (\x -> transform x mappings2 mappings3) [".#.", "..#", "###"]
    print $ countOn $ iterateN 5 0 (\x -> transform x mappings2 mappings3) [".#.", "..#", "###"]
