...
run !grid !pose !iteration !numInfected
    | iteration >= 10000000 = numInfected
    | otherwise =
        let currentCoord = coord pose
            ...
            newDirection
                ...
                | currentNode == '.' && currentDir == DUp = DLeft
                | currentNode == '.' && currentDir == DDown = DRight
                | currentNode == '.' && currentDir == DLeft = DDown
                | currentNode == '.' && currentDir == DRight = DUp
                | currentNode == 'W' = currentDir
                | currentNode == 'F' && currentDir == DUp = DDown
                | currentNode == 'F' && currentDir == DDown = DUp
                | currentNode == 'F' && currentDir == DLeft = DRight
                | currentNode == 'F' && currentDir == DRight = DLeft
            newStatus
                | currentNode == '.' = 'W'
                | currentNode == 'W' = '#'
                | currentNode == '#' = 'F'
